...
class Post(models.Model):
    ...
    edited = models.BooleanField(default=False, verbose_name='Изменен ли?')
    likes = models.ManyToManyField(User, blank=True, related_name='liked_posts', verbose_name='Лайки поста')
